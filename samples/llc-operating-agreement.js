...
export const model = {
  variables: {
    ...
    'Members[].SignerName': { label: 'Name of person signing for the entity (entity members only)', type: 'text', required: false, help: 'Leave blank to print a signature line to fill in by hand.' },
    'Members[].SignerTitle': { label: "Signer's title (entity members only)", type: 'text', required: false },
